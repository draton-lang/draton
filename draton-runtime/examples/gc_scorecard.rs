...
fn main() {
    ...
    println!(
        ...
        stats.major_autotune_adjustments,
        ...
        stats.large_free_pool_count,
        stats.large_free_bytes,
        stats.roots_count,
        ...
        stats.current_gc_threshold_milli,
        stats.major_phase,
