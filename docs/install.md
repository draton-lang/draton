...
```sh
curl -fsSL https://github.com/draton-lang/draton/releases/download/v0.1.39/install.sh | sh
```

Pin a specific tag:

```sh
curl -fsSL https://github.com/draton-lang/draton/releases/download/v0.1.39/install.sh | sh -s -- --version v0.1.39
```
...
```powershell
Invoke-WebRequest `
  -Uri https://github.com/draton-lang/draton/releases/download/v0.1.39/install.ps1 `
  -OutFile install.ps1
.\install.ps1 -Version v0.1.39
```
